...
//axios.get(`http://192.168.200.171:9000/check/${mirrorDB.getId()}`)
...
//             if (data.type == 'image') {
//                 axios({
//                     url: 'http://192.168.200.171:9000/get/image', // 통신할 웹문서
//                     method: 'post', // 통신할 방식
...
//                 axios({
//                     url: 'http://192.168.200.171:9000/get/audio', // 통신할 웹문서
//                     method: 'post', // 통신할 방식
//                     data: { fileName: data.content }
//                 })//받아온 파일 저장
//                     .then(response => {
...
//         //서버에게 메시지 잘 받았다고 보내기
//         axios({
//             url: 'http://192.168.200.171:9000/set/userState', // 통신할 웹문서
//             method: 'post', // 통신할 방식
